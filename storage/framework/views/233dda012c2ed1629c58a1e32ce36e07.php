                    ...
                    <div class="flex flex-col h-full">
                        <div class="mb-6">
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 <?php echo e($profile->section === 'tentang_sekolah' ? 'bg-indigo-50 text-indigo-600' : ($profile->section === 'visi_misi' ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600')); ?>">
                                ...
                                <?php elseif($profile->section === 'visi_misi'): ?>
                                    <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <h3 class="text-xl font-black text-gray-900 mb-2"><?php echo e($profile->title); ?></h3>
                            <p class="text-sm text-gray-400 leading-relaxed line-clamp-3">
                                <?php echo e(Str::limit($profile->short_description, 100)); ?>

                            </p>
                        </div>

                        <div class="mt-auto pt-8 border-t border-gray-50 flex items-center justify-between">
                            <span class="text-[0.65rem] font-black uppercase tracking-widest text-gray-300">Update: <?php echo e($profile->updated_at->diffForHumans()); ?></span>
                            <a href="<?php echo e(route('admin.profiles.edit', $profile->section)); ?>" class="admin-btn admin-btn-primary scale-90 origin-right">
                                Kelola
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\portalWeb\portalWeb\resources\views/admin/profiles/index.blade.php ENDPATH**/ ?>