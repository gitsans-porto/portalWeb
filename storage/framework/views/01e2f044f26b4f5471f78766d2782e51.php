        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-18 lg:h-20">
                ...
                <div class="hidden lg:flex items-center gap-8">
                    ...
                    <a href="<?php echo e(route('beranda')); ?>#layanan" class="nav-link">Layanan</a>
                    <a href="<?php echo e(route('beranda')); ?>#profil" class="nav-link">Profil</a>
...
</html><?php /**PATH C:\laragon\www\PortalWeb\resources\views/layouts/app.blade.php ENDPATH**/ ?>