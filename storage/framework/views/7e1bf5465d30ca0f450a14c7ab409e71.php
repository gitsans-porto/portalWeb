            ...
            <div class="flex items-center justify-between h-18 lg:h-20">
                ...
                <div class="hidden lg:flex items-center gap-8">
                    ...
                    <div class="nav-item-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="<?php echo e(route('beranda')); ?>#profil" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                Tentang Sekolah
                            </a>
                            <a href="<?php echo e(route('beranda')); ?>#profil" class="dropdown-link">
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <div class="py-2">
            ...
            <div class="mobile-nav-group">
                ...
                <div class="mobile-submenu">
                    <a href="<?php echo e(route('beranda')); ?>#profil" class="nav-link !pl-10 !border-none !text-sm">Tentang Sekolah</a>
                    <a href="<?php echo e(route('beranda')); ?>#profil" class="nav-link !pl-10 !border-none !text-sm">Visi & Misi</a>
                    <a href="<?php echo e(route('beranda')); ?>#profil" class="nav-link !pl-10 !border-none !text-sm">Kepala Sekolah</a>
                </div>
            </div>
            <a href="<?php echo e(route('beranda')); ?>#berita" class="nav-link">Berita</a>
            <a href="<?php echo e(route('beranda')); ?>#kontak" class="nav-link">Kontak</a>
