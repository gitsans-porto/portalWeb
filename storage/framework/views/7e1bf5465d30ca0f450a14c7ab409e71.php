...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Portal Layanan'); ?> — SMKN 1 Limboto</title>
    <meta name="description"
        content="<?php echo $__env->yieldContent('meta_description', 'Portal Layanan Sistem Informasi Terpadu SMKN 1 Limboto — Akses E-Raport, LMS, Dapodik, dan PeKaeL dalam satu platform.'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Portal Layanan'); ?> — SMKN 1 Limboto">
    <meta property="og:description"
        content="<?php echo $__env->yieldContent('meta_description', 'Portal Layanan Sistem Informasi Terpadu SMKN 1 Limboto'); ?>">
...
<body class="antialiased">
    ...
    <nav class="navbar" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-18 lg:h-20">
                ...
                <a href="<?php echo e(route('beranda')); ?>" class="flex items-center gap-3 no-underline shrink-0">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo SMKN 1 Limboto" class="w-auto h-12 object-contain drop-shadow-md">
                    <div>
                        <span
                ...
                <div class="hidden lg:flex items-center gap-8">
                    <a href="<?php echo e(route('beranda')); ?>"
                        class="nav-link <?php echo e(request()->routeIs('beranda') ? 'active' : ''); ?>">Beranda</a>
                    <div class="nav-item-dropdown">
                        <a href="<?php echo e(route('beranda')); ?>#layanan" class="nav-link">
                            Layanan
                        ...
                        <div class="dropdown-menu">
                            <a href="<?php echo e(route('layanan.detail', 'e-raport')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                E-Raport
                            </a>
                            <a href="<?php echo e(route('layanan.detail', 'lms')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                LMS
                            </a>
                            <a href="<?php echo e(route('layanan.detail', 'dapodik')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                Dapodik
                            </a>
                            <a href="<?php echo e(route('layanan.detail', 'pekael')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                PeKaeL
                            </a>
                        </div>
                    ...
                    <div class="nav-item-dropdown">
                        <a href="<?php echo e(route('beranda')); ?>#profil" class="nav-link">
                            Profil
                            <svg class="nav-arrow inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div class="dropdown-menu">
                            <a href="<?php echo e(route('profil.tentang')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                Tentang Sekolah
                            </a>
                            <a href="<?php echo e(route('profil.visi-misi')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                Visi & Misi
                            </a>
                            <a href="<?php echo e(route('profil.kepala-sekolah')); ?>" class="dropdown-link">
                                <div class="w-2 h-2 rounded-full bg-primary/40 shrink-0"></div>
                                Kepala Sekolah
                            </a>
                        </div>
                    </div>
                    <a href="<?php echo e(route('beranda')); ?>#berita" class="nav-link">Berita</a>
                    <a href="<?php echo e(route('beranda')); ?>#kontak" class="nav-link">Kontak</a>
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <div class="py-2">
            <a href="<?php echo e(route('beranda')); ?>" class="nav-link">Beranda</a>
            <div class="mobile-nav-group">
                ...
                <div class="mobile-submenu">
                    <a href="<?php echo e(route('layanan.detail', 'e-raport')); ?>" class="nav-link !pl-10 !border-none !text-sm">E-Raport</a>
                    <a href="<?php echo e(route('layanan.detail', 'lms')); ?>" class="nav-link !pl-10 !border-none !text-sm">LMS</a>
                    <a href="<?php echo e(route('layanan.detail', 'dapodik')); ?>" class="nav-link !pl-10 !border-none !text-sm">Dapodik</a>
                    <a href="<?php echo e(route('layanan.detail', 'pekael')); ?>" class="nav-link !pl-10 !border-none !text-sm">PeKaeL</a>
                </div>
            </div>
            <div class="mobile-nav-group">
                <button class="mobile-dropdown-btn">
                ...
                <div class="mobile-submenu">
                    <a href="<?php echo e(route('profil.tentang')); ?>" class="nav-link !pl-10 !border-none !text-sm">Tentang Sekolah</a>
                    <a href="<?php echo e(route('profil.visi-misi')); ?>" class="nav-link !pl-10 !border-none !text-sm">Visi & Misi</a>
                    <a href="<?php echo e(route('profil.kepala-sekolah')); ?>" class="nav-link !pl-10 !border-none !text-sm">Kepala Sekolah</a>
                </div>
            </div>
            <a href="<?php echo e(route('beranda')); ?>#berita" class="nav-link">Berita</a>
            <a href="<?php echo e(route('beranda')); ?>#kontak" class="nav-link">Kontak</a>
    ...
    <footer class="footer" id="kontak">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div class="lg:col-span-1">
                    <div class="flex items-center gap-3 mb-5">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo SMKN 1 Limboto"
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('beranda')); ?>" class="text-sm hover:text-white/100">Beranda</a></li>
                        <li><a href="<?php echo e(route('beranda')); ?>#layanan" class="text-sm hover:text-white/100">Layanan</a>
                        </li>
                        <li><a href="<?php echo e(route('beranda')); ?>#profil" class="text-sm hover:text-white/100">Profil
                                Sekolah</a></li>
                        <li><a href="<?php echo e(route('beranda')); ?>#berita" class="text-sm hover:text-white/100">Berita &
                                Kegiatan</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('layanan.detail', 'e-raport')); ?>"
                                class="text-sm hover:text-white/100">E-Raport</a></li>
                        <li><a href="<?php echo e(route('layanan.detail', 'lms')); ?>" class="text-sm hover:text-white/100">LMS</a>
                        </li>
                        <li><a href="<?php echo e(route('layanan.detail', 'dapodik')); ?>"
                                class="text-sm hover:text-white/100">Dapodik</a></li>
                        <li><a href="<?php echo e(route('layanan.detail', 'pekael')); ?>"
            ...
            <div class="border-t border-white/10 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-xs text-white/40">&copy; <?php echo e(date('Y')); ?> SMKN 1 Limboto. Seluruh hak cipta dilindungi.
                </p>
...
</html><?php /**PATH C:\xampp\htdocs\portalWeb\portalWeb\resources\views/layouts/app.blade.php ENDPATH**/ ?>