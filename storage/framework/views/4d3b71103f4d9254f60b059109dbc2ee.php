        ...
        <div class="relative overflow-hidden mb-10 rounded-[3rem] bg-white p-10 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100">
            <div class="relative z-10 max-w-2xl">
                ...
                <h1 class="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight leading-tight">
                    Selamat Datang, <span class="text-red-600"><?php echo e(Auth::user()->name); ?></span>!
                </h1>
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('admin.profiles.index')); ?>" class="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-red-600 text-white font-bold hover:bg-red-700 transition-all shadow-lg shadow-red-200 hover:-translate-y-1">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2 admin-card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <?php $__currentLoopData = ['tentang_sekolah' => ['Tentang Sekolah', 'bg-red-50', 'text-red-600', 'informasi riwayat dan profil sekolah'], 'visi_misi' => ['Visi & Misi', 'bg-red-50', 'text-red-600', 'pedoman arah dan tujuan sekolah'], 'kepala_sekolah' => ['Kepala Sekolah', 'bg-amber-50', 'text-amber-600', 'sambutan dan profil pimpinan']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col p-6 bg-gray-50 rounded-3xl border border-gray-100 hover:border-red-200 transition-all group">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="<?php echo e(route('admin.profiles.edit', $key)); ?>" class="opacity-0 group-hover:opacity-100 transition-opacity p-2 rounded-xl bg-white text-red-600 shadow-sm">
            ...
            <div class="admin-card">
                ...
                <div class="space-y-4">
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="flex items-center gap-4 p-4 rounded-2xl border border-gray-100 hover:bg-red-50 hover:border-red-200 transition-all group">
