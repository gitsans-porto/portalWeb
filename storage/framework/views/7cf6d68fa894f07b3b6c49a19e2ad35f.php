<?php $__env->startSection('title', 'Edit Tata Cara - ' . $service->name); ?>

<?php $__env->startSection('content'); ?>
<div class="p-6">
    <div class="mb-8">
        <a href="<?php echo e(route('admin.services.index')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-red-600 transition-colors mb-4 group">
        ...
        <p class="text-gray-500 text-sm">Sesuaikan langkah-langkah prosedur untuk layanan <span class="font-bold text-red-600"><?php echo e($service->name); ?></span>.</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50 border border-gray-100 rounded-3xl p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" value="<?php echo e($service->name); ?>" disabled class="w-full px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-400 font-medium">
                    </div>
                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Slug (URL)</label>
                        <input type="text" value="<?php echo e($service->slug); ?>" disabled class="w-full px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-400 font-medium font-mono">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-3xl p-8">
                ...
                <div id="sop-container" class="space-y-6">
                    ...
                    <?php $__currentLoopData = $sopData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="sop-step group bg-gray-50 rounded-2xl p-6 border border-gray-100 relative" data-index="<?php echo e($index); ?>">
                            <div class="flex items-start justify-between gap-4 mb-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h4 class="font-bold text-gray-900">Langkah <span class="index-num"><?php echo e($index + 1); ?></span></h4>
                                </div>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <input type="text" name="sop[<?php echo e($index); ?>][title]" value="<?php echo e($step['title'] ?? ''); ?>" placeholder="Judul Langkah (Contoh: Login ke Sistem)" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 outline-none transition-all font-bold text-gray-900" required>
                                <textarea name="sop[<?php echo e($index); ?>][desc]" rows="3" placeholder="Deskripsi detail apa yang harus dilakukan..." class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 outline-none transition-all text-sm text-gray-600 leading-relaxed" required><?php echo e($step['desc'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>

                <?php if(count($sopData) == 0): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\portalWeb\portalWeb\resources\views/admin/services/edit.blade.php ENDPATH**/ ?>