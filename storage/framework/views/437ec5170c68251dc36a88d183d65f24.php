...
<body class="antialiased font-sans bg-gray-50">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="mt-4">
            ...
            <a href="<?php echo e(route('admin.news.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/news*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('admin.services.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/services*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
