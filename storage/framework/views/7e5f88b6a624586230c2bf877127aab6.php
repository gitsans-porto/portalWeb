            ...
            <div class="bg-white rounded-3xl border border-gray-200 overflow-hidden hover:border-red-200 transition-all group">
                <div class="p-6">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 rounded-2xl bg-<?php echo e($service->color); ?>-50 flex items-center justify-center text-<?php echo e($service->color); ?>-600">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-900"><?php echo e($service->name); ?></h3>
                            <span class="text-[10px] font-black uppercase tracking-widest text-<?php echo e($service->color); ?>-500"><?php echo e($service->tagline); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-50">
                        <span class="text-xs font-semibold text-gray-400">
                            <?php echo e(count($service->sop ?? [])); ?> Langkah Prosedur
                        </span>
                        <a href="<?php echo e(route('admin.services.edit', $service->id)); ?>" class="flex items-center gap-2 text-sm font-bold text-red-600 hover:text-red-700 transition-colors">
                            Edit Tata Cara
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\portalWeb\portalWeb\resources\views/admin/services/index.blade.php ENDPATH**/ ?>