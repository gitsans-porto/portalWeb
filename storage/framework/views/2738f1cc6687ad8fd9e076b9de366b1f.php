    ...
    <section class="detail-hero">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center gap-2 text-sm text-white/40 mb-8">
                ...
                <a href="<?php echo e(route('beranda')); ?>#layanan" class="hover:text-white/70 transition-colors">Layanan</a>
                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>
                ...
                <?php $__currentLoopData = $layanan['sop']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="sop-step reveal reveal-delay-<?php echo e(($index % 4) + 1); ?>">
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-gray-900 text-lg mb-2"><?php echo e($step['title']); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\portalWeb\portalWeb\resources\views/layanan.blade.php ENDPATH**/ ?>