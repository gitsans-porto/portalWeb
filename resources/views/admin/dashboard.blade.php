    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
            <div>
                ...
                <p class="text-gray-500 mt-1">Selamat datang kembali, {{ Auth::user()->name }}. Kelola portal layanan Anda di sini.</p>
            </div>
            <div class="flex items-center gap-3">
                ...
                <span class="text-gray-500 text-sm">{{ date('d F Y') }}</span>
            </div>
        </div>
