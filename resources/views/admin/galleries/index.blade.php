...
<div class="reveal">
    ...
    {{-- Form Tambah Foto --}}
    <div class="bg-white rounded-lg p-8 shadow-sm border border-gray-100 mb-10">
        ...
        <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="file" name="image" required class="w-full text-sm text-gray-500 file:mr-4 file:py-3 file:px-6 file:rounded-md file:border-2 file:border-dashed file:border-red-600 file:text-sm file:font-bold file:bg-transparent file:text-red-600 hover:file:bg-red-50 hover:file:border-red-700 hover:file:text-red-700 cursor-pointer transition-all">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($galleries as $gallery)
            <div class="bg-white rounded-lg overflow-hidden border border-gray-100 shadow-sm group">
        ...
        @empty
            <div class="col-span-full py-16 text-center bg-white rounded-lg border border-gray-100 border-dashed">
