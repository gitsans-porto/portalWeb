    ...
    <div class="reveal">
        ...
        <div class="mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div>
                ...
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Edit Berita</h1>
            </div>
        </div>
                    ...
                    <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <p class="text-[10px] text-gray-400 italic">Biarkan kosong jika tidak ingin mengubah gambar.</p>
                            </div>
                        </div>
                    </div>
