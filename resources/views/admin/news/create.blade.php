...
@section('content')
    <div class="reveal">
        ...
        <div class="mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div>
                <a href="{{ route('admin.news.index') }}" class="inline-flex items-center text-sm font-bold text-gray-400 hover:text-red-600 transition-colors mb-2">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <textarea id="content" name="content" rows="15" 
                                    ...
                                    placeholder="Tuliskan isi berita lengkap di sini..." required>{{ old('content') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <input type="datetime-local" id="published_at" name="published_at" value="{{ old('published_at', date('Y-m-d\TH:i')) }}"
