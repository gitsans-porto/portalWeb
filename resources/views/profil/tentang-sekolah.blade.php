        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden reveal">
                ...
                <div class="p-8 md:p-16 lg:p-20">
                    ...
                    <div class="flex justify-center mb-16">
                        <div class="w-full max-w-3xl rounded-3xl overflow-hidden shadow-2xl border-4 border-white ring-1 ring-gray-100 transition-transform duration-500 hover:scale-[1.01]">
                            <img src="{{ $profile->image && Storage::disk('public')->exists($profile->image) ? asset('storage/' . $profile->image) : asset($profile->image) }}" alt="{{ $profile->title }}" class="w-full h-auto object-cover">
                        </div>
                    </div>
                    ...
                    <div class="mt-16">
                        ...
                        <div class="group relative">
                            ...
                            {{-- Gunakan inline style height untuk memastikan peta tetap tinggi --}}
                        ...
                        <div class="mt-8 flex flex-col md:flex-row items-center justify-center gap-6 text-sm text-gray-500 italic">
                            <div class="flex items-center gap-2">
                                ...
                                <span>{{ $profile->additional_data['address'] ?? 'Jl. Jend. Panjaitan, Limboto, Gorontalo' }}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span>Buka: {{ $profile->additional_data['opening_hours'] ?? 'Senin - Jumat (07:00 - 15:30)' }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50/50 p-10 text-center border-t border-gray-50">
                    <p class="text-sm font-medium text-gray-400 tracking-wide uppercase">© {{ date('Y') }} {{ $profile->title }} — Sekolah Rujukan Berkualitas</p>
                </div>
            </div>

            {{-- Back Button --}}
            <div class="mt-10 text-center">
                <a href="{{ route('beranda') }}" class="btn-outline">
